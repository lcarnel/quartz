...
<section>
    ...
    <h1>Simpel Presenteren</h1>
    <footer>door L.Carnel</footer>
</section>

<section>
    <p>Een beetje doodgewone tekst: But I've never been to the moon!<br> You can see how I lived before I met you. Also Zoidberg.
    I could if you hadn't turned on the light and shut off my stereo.<br> En kan dit er nog bij</p>
</section>

<section>
    <h3>Een lijst stap voor stap tonen</h3>
    <ul>
      <li class="next">Item 1 : Inleiding
      <li class="next">Item 2 : Overzicht
      <li class="next">Item 3 : Conclusie
        <ul>
          <li class="next"> Item 3.1 : Niveau
